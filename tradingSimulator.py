...
transactionCosts = percentageCosts[2]/100
...
class TradingSimulator:
    ...
    def simulateNewStrategy(self, strategyName, stockName,
                            ...
                            saveStrategy=False, custom_save_path=None, custom_load_path=None):
        """
        ...
        INPUTS: - strategyName: Name of the trading strategy.
                ...
                - custom_save_path: Custom path to save the trading strategy.
                - custom_load_path: Custom path to load the trading strategy.
    ...
    def simulateExistingStrategy(self, strategyName, stockName,
                                 ...
                                 observationSpace=observationSpace, actionSpace=actionSpace, 
                                 money=money, stateLength=stateLength, transactionCosts=transactionCosts,
                                 rendering=True, showPerformance=True, custom_load_path=None):
        """
        ...
        if exists:
            ...
            raise SystemError(f"The trading strategy specified does not exist at path: {fileName}")
